                      ...
                      <div className="flex flex-col lg:flex-row lg:items-center gap-4">
                        ...
                        <div className="flex items-center justify-end gap-2 flex-shrink-0">
                          <button
                            ...
                            className="w-10 h-10 flex items-center justify-center rounded-xl bg-yellow-500/20 text-yellow-300 hover:bg-yellow-500/30 hover:text-yellow-200 transition-colors"
                            title="ดูรายละเอียด"
                          >
                          ...
                          {canEdit && (
                            <button
                              ...
                              className="w-10 h-10 flex items-center justify-center rounded-xl bg-blue-500/20 text-blue-300 hover:bg-blue-500/30 hover:text-blue-200 transition-colors"
                              title="แก้ไข"
                            >
